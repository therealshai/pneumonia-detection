  ...
  return (
    <div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="p-6 sm:p-8 group/file block rounded-lg cursor-pointer w-full relative overflow-hidden"
      >
        <input
          ref={fileInputRef}
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <p className="relative z-20 font-sans font-normal text-neutral-400 dark:text-neutral-400 text-xs sm:text-sm mt-2 text-center">
            Drag or drop PNG, JPG, GIF files here or click to upload
          </p>
            ...
            {!files.length && (
              ...
              >
                {isDragActive ? (
                  ...
                  >
                    Drop images
                    <IconUpload className="h-3 w-3 sm:h-4 sm:w-4 text-neutral-600 dark:text-neutral-400 mt-1" />
                  </motion.p>
                ) : (
